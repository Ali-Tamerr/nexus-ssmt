  ...
  return (
    <div className="flex flex-col items-center justify-center py-20">
      <div className="relative mb-8">
        <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-[#3B82F6]/30 to-indigo-600/30 blur-xl" />
        <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-[#3B82F6] to-indigo-600">
      ...
      <div className="mt-8 flex gap-4">
        <button
          onClick={onSignup}
          className="rounded-lg bg-[#3B82F6] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#265fbd]"
        >
          Create free account
        </button>
        <button
